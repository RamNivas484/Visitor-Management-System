            ...
            <div class="row">
                <div class="col-sm-3 col-md-offset-0">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                          <ul class="nav" id="side-menu">
                              <li><a href="{{ url('/visitor/editprofile') }}"><i class="glyphicon glyphicon-home"></i> Edit My Profile</a></li>
                              <li><a href="{{ url('/visitor/checkavailability') }}"><i class="glyphicon glyphicon-user"></i> Check Availability</a></li>
                              <li><a href="{{ url('/visitor/bookemployee') }}"><i class="glyphicon glyphicon-sunglasses"></i> Book Employee</a></li>
                              <li><a href="{{ url('/visitor/changepassword') }}"><i class="glyphicon glyphicon-sunglasses"></i> Change Password</a></li>
                              <li><a href="{{ url('/visitor/entrylog') }}"><i class="glyphicon glyphicon-sunglasses"></i> Entry Log</a></li>
                              <li><a href="{{ url('/visitor/bookedstatus') }}"><i class="glyphicon glyphicon-sunglasses"></i> Booked Status</a></li>
                          </ul>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 col-md-offset-0">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                          <form name="form1" class="form-horizontal" role="form" method="POST" action="{{ url('/visitor/bookemployee') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="emp_name" name="emp_name" type="text" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="emp_email" class="col-md-4 control-label">Employee mail ID</label>
                                    <div class="col-md-6">
                                        <input id="emp_email" name="emp_email" type="text" class="form-control input-md">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="time" class="col-md-4 control-label">Time Required </label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input id="purpose" name="purpose" type="text" class="form-control input-md">
                                    </div>
                                </div>
                                <!-- getting person -->
